...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      _extends({}, divProps, { className: className, style: style, onClick: this.onCellClick, onDoubleClick: this.onCellDoubleClick, onContextMenu: this.onCellContextMenu, onDragOver: this.onDragOver }, events),
	      cellContent,
	      dragHandle
	    );
	  }
